...
1️⃣ Нажмите ниже кнопку - <b>«📸Оживить фото»</b>
2️⃣ <i>Отправьте одну фотографию* в бот.</i>
3️⃣ <i>Опишите,</i> что именно должно произойти на изображении — движение, эмоции, детали, любые пожелания ✨
4️⃣ <i>Немного подождите</i> — примерно через 3 минуты бот отправит вам готовое видео 🎬⚡️
