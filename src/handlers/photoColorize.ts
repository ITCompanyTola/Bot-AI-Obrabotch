...
📸 Добавление цвета на 1 фото = ${PRICES.PHOTO_COLORIZE}₽

❗️* - <b>бот добавляет цвета только на одно фото за раз</b>☝🏻`.trim();
...
💰 Ваш баланс: ${balance.toFixed(2)} ₽
📸 Добавить цвет на 1 фото = ${PRICES.PHOTO_COLORIZE}₽
