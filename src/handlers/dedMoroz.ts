...
🎅 Поздравление Д.Мороза: ${PRICES.DED_MOROZ.toFixed(2)}₽</blockquote>
...
<blockquote><code>Привет,'Имя ребенка'!\nПоздравляю тебя С Новым годом!\nПусть сбудутся все мечты, а чудеса и радость всегда будут рядом</code></blockquote>
